/* dplane.js — Dispatchis v2.5.60 — Module planning Dplane v5.0 */
...
async function dplaneBriefingGestionnaire() {
  if (!currentUserData) return;
  const today = dplaneDateStr(new Date());
...
// ── Switcher ──
// switchTool() déplacé dans core.js (v2.5.59)
// Appeler directement switchTool('dplane'|'dvol'|'dispatch') depuis core.js
// FIN DPLANE v5.0
