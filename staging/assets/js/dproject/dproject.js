/* =========================================================
   ...
   v2.1 — Fix critique : JS extrait du innerHTML
   Onglet Bugs : ✅ fonctionnel
   Onglets Évolutions / Tâches / Roadmap : 🔜 à venir

   ── Pourquoi cette version ──
   La v2.0 plaçait toutes les fonctions JS à l'intérieur d'une
   balise <script> elle-même injectée via innerHTML. Or les
   navigateurs n'exécutent JAMAIS un <script> inséré ainsi
   (sécurité du DOM). Résultat : le visuel s'affichait, mais
   aucune fonction ne tournait, aucune donnée Supabase ne se
   chargeait, aucun onclick ne répondait.
   La v2.1 sort tout le JS au niveau du module (fichier .js)
   et appelle les init après innerHTML. Logique et visuel
   strictement identiques à la v2.0.
   ========================================================= */
...
/* =========================================================
   ...
   (le JS a été extrait au-dessus de cette fonction)
   ========================================================= */
